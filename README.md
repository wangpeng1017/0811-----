...
### Google Gemini API错误解决

#### 401 身份验证失败
**可能原因：**
- API Key无效或已过期
- API Key格式错误
- 项目没有开启Generative Language API

**解决方案：**
1. 访问 [https://console.cloud.google.com/](https://console.cloud.google.com/) 检查项目状态
2. 启用Generative Language API
3. 重新生成API Key
4. 更新 `.env.local` 文件中的 `GEMINI_API_KEY`
5. 重启应用
...
4. **API Key配置**: 检查 `.env.local` 文件是否正确配置
...
感谢以下技术和服务的支持：
- [Google AI](https://ai.google.dev/) - Gemini Pro Vision视觉推理模型
